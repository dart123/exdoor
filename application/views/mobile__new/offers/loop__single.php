            ...
            <?php if ( $is_author ):?>
                <div class="req-item__helpers">
                    <ul class="req-item__actions is-rounded is-box-shadow">
                        ...
                        <li class="is-last-item    js__clipboard__copy_link" data-clipboard-text="<?=$this->config->item('base_url');?>/offers/<?php echo $type;?>/<?php echo $id;?>">
                            Скопировать ссылку
                        </li>
                    </ul>
                </div>
            <?php else:?>
                <p class="offers__share_link is-blue-link        js__clipboard__copy_link" data-clipboard-text="<?=$this->config->item('base_url');?>/offers/<?php echo $type;?>/<?php echo $id;?>">
