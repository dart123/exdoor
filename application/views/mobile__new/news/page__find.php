    ...
    <div class="content ">
        ...
        <?php if( !array_key_exists("taxonomy", $page_content ) || !$page_content["taxonomy"]["page"] ):?>
            <section class="news-submenu flex-row">
                <a href="/news" class="news-submenu__item">Все Новости</a>
                <a href="/news/exdor" class="news-submenu__item">Новости проекта</a>
            </section>
        <?php endif;?>
...
<?php
    ...
    $this->load->view('mobile/news/js/search_load_items');
