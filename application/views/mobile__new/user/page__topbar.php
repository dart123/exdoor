...
<div class="header__icons t-hide">
    ...
    elseif ( isset( $page_content["request_data"] ) && current_url() != $this->config->item('item_name')."/requests/add"):?>
        ...
        <div class="request_menu__actions">
            ...
            <ul class="request_menu__actions__item is-box-shadow">
                ...
                <?php if( $page_content["request_data"]->can__set_rating ):?>
                    <li class="js__requests__context_menu" data-href="<?=$this->config->item('base_url');?>/requests/<?php echo $page_content["request_data"]->id;?>?set_rating=true">
