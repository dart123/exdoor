...
<script>
    ...
    $(".request__reset-btn").click(function() {
        ...
        $('#sorting-requests').find('.ajax__requests_filter_input__submit').click();
    });



    $('.ajax__requests_filter_input__submit').click( function() {
                ...
                if (data) {
                    ...
                    data.forEach(function(item, i, data) {
                        ...
                        if( item.requests.length ) {
                            ...
                            $('.ajax__requests_container__user_'+item.user).append('<div class="my-partners__last is-no-select request__item      request_list__not_found">Не найдено объявлений по заданным Вами параметрам</div>');
