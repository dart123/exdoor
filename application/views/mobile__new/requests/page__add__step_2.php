                            ...
                            <?php if( array_key_exists("request_positions", $page_content) && !empty($page_content["request_positions"])):?>
                                ...
                                <?php foreach ($page_content["request_positions"] as $key => $position):?>
                                    ...
                                    <div class="requests-step__form-2">
                                        ...
                                        <div class="req__col">
                                            <?php if( $key != 0 ):?>
                                                <a href="" class="js-del-step-form  is-or-link"><i class="fa fa-trash-alt"></i></a>
                                            <?php endif;?>
                                        </div>
                                        <div class="req__col">
                                        ...
                                        success: function(result){
                                            if (result) {
                                                ...
                                                result.images.forEach(function(item, i, data) {
                                                    ...
                                                    $(li).append("<a href='#' class='edit js__image_edit__open_editor' data-image-original-url='<?=$this->config->item('base_url');?>/uploads/equipment/<?php if ($page_content["request_data"]->eq_id) echo $page_content["request_data"]->eq_id;?>/lg1000_" + item + "' data-image-original-name='" + item + "' ></a>");
