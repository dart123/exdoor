    ...
    <div class="content">
        ...
        <main class="feedback feedback--nums-<?php echo count($page_content["request_positions"]);?>">
            <div class="container">
                                                            ...
                                                            <div class="feedback__content">
                                                                ...
                                                                <?php else:?>
                                                                    <?php if( $request_partner->request_response_data->can_re_response):?>
                                                                        <a class="js__send_re-response feedback__choose-executant__unactual is-last-item" data-request-id="<?php echo $page_content["request_data"]->id;?>" data-partner-id="<?php echo $request_partner->user_id;?>">
                                                                            <div class="feedback__helper is-last-item">
                                                                                <div>
                ...
                <!--  Подверждение  -->
                <div id="confirm" class="modal  modal--middle">
                    ...
                    <div style="background: #fff;" class="modal-body">
                        <p>В качестве исполнителя заявки Вы хотите выбрать: <b id="js__executor_name"></b>.</p>
                        <p class="is-mtop-5">После подтверждения данного действия Вы не сможете изменить исполнителя.</p>
                        <p class="is-mtop-5">Вы готовы подвердить свое решение?</p>

                        <form id="request__set_executor_form" method="POST" action="/requests/<?php echo $page_content["request_data"]->id;?>">
                            ...
                            <div class="confirm__block center is-mtop-20">
                                <a href="#" onclick="$('#request__set_executor_form').submit();" class="bl-btn      confirm__block-btn btn ripple-effect btn-primary2 is-rounded">
                                ...
                                &nbsp;
                                &nbsp;
                                <a href="#" class="modal__close-btn pointer confirm__block-btn btn ripple-effect or-btn btn-info is-rounded">
                                    <i class="fa fa-times"></i>
                                    <span>Отмена</span>
                                </a>
                            </div>
                                ...
                                <?php if( $r_partner->responses[$r_position->id] ):?>
                                    ...
                                    <?php else:?>
                                        <?php if( $r_partner->responses[$r_position->id]->shipping ):?>
                                            <i class="fa fa-clock"></i> <?php echo $r_partner->responses[$r_position->id]->shipping;?> день
                                        <?php else:?>
                                            <div class="is-grey-text">нет в наличии</div>
                                        <?php endif;?>
                                    <?php endif;?>
...
<?php
    ...
    $this->load->view('mobile/requests/js/in_process_send_re-response');
