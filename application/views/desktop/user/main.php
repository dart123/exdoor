 ...
 * Date: 29.06.16
 * Time: 17:06
 * Description: Отображения страницы пользователя при низком уровне заполненности
 */
?>
        ...
        <section class="page-content">
            <div class="section-user-info is-rounded is-box-shadow js__user_info_block">
                ...
                <div class="section-user-info__profile user-profile">
                    <div class="user-profile__empty-contact is-grey-text">
                        <?php if ( $user->name || $user->last_name || $user->second_name ):?>
                            <?php echo $user->name;?> <?php echo $user->last_name;?> <?php echo $user->second_name;?>
                        <?php else:?>
                            <?php echo $this->phone->phone($user->phone);?>
                        <?php endif;?>
                    </div>
                    ...
                    <div class="user-profile__empty-title is-or-text is-mtop-20">
                        Сделайте рабочее пространство эффективным, <a class="is-or-link" href="/profile"><span>дополнив информацию о себе</span></a>
                    </div>
                    <div class="user-profile__empty-text is-grey-text">
                        Ваш профиль — это не просто анкета, но и визитная карточка, открывающая широкие возможности по расширению партнерской сети.
                    </div>
                </div>
                <?php if( $this->session->user == $user->id ):?>
