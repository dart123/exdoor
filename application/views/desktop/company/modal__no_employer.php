...
?>
<!--  Подверждение  -->
<div id="company__modal__no_employer" class="modal__block is-rounded">
    ...
    <div class="modal__content">
        ...
        <div class="confirm__block">
            <a class="js__company__modal__no_employer pointer confirm__block-btn btn ripple-effect btn-primary2 is-rounded">
