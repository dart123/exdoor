            ...
            <div class="feed-back">
                ...
                <div class="requests-step__line no-print">
                    <div class="requests-step__title requests-step__title__compare">
                        ...
                        <?php if( isset( $_GET['employer'] ) && $_GET['view'] == 'b'):?>
                            <a href="/requests/<?php echo $request_data->id;?>?view=b&employer=<?php echo $_GET['employer'];?>" class="is-blue-link">
                                ...
                                if( $request_partners ):
                                    foreach ( $request_partners as $request_partner ):
                                        ...
                                        switch ($request_partner->last_status):
                                            case 'send':?>
                                                <li  class="feedback__item feedback__item--processing processing send" <?php if($request_data->executor):?> style="opacity: 0.5" <?endif;?> data-response-id="<?php echo $request_partner->response_id;?>">
                                                ...
                                                <?php break;?>
                                            <?php case 'read':?>
                                            <li  class="feedback__item feedback__item--processing processing read" <?php if($request_data->executor):?> style="opacity: 0.5" <?endif;?> data-response-id="<?php echo $request_partner->response_id;?>">
                                                <div class="feedback__head is-first-item">
                                                    <a href="" class="feedback__img">
                                                        <?php if( $request_partner->avatar ):?>
                                                            <img src="/uploads/users/<?php echo $request_partner->user_id;?>/avatar/80x80_<?php echo $request_partner->avatar;?>" class="img-responsive" alt="">
                                        ...
                                        <?php
                                            case 'canceled':
                                                if( !$request_data->executor || $request_partner->user_id == $request_data->executor )
                                                    $opacity    = 1;
                                                else $opacity    = 0.5;
                                                ?>
