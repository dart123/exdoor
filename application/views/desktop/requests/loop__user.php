...
<div class="requests__col is-rounded is-box-shadow requests__col__user_<?php echo $id;?>" <?php if(
                                                                                                ...
                                                                                                (
                                                                                                    (
                                                                                                        ...
                                                                                                        &&
                                                                                                        !in_array($id, $filter_saved->employers__to_show)
                                                                                                    )
                                                                                                    ||
    ...
    <div class="my-partners__row write-msg">
        ...
        <div class="my-partners__rcell">
            <div>
                <a class="js-partner__open_chat  is-blue-link pointer" data-user-id="<?php echo $this->session->user;?>" data-partner-id="<?php echo $id;?>">
    ...
    <div class="section-user-request__block ajax__requests_container ajax__requests_container__user_<?php echo $id;?> ajax__request_list__<?php echo $id;?>__<?php echo $sub_menu['selected'];?>">
        <?php

            if($pre_requests):
                foreach ( $pre_requests as $key => $req ):
                    $this->load->view('desktop/requests/loop__block', $req);
                endforeach;
            endif;
            ?>
