...
<script>
    $(document).ready( function () {
            ...
            $.post('/ajax/partners__remove_user',
                ...
                function(result) {
                    ...
                    if (data) {
                        ...
                        obj_this.closest('.my-partners__rcell').find('.js-partner__remove_user').addClass('is-hidden');
                        obj_this.closest('.my-partners__rcell').find('.js-partner__undo_remove_user').removeClass('is-hidden');
                    }
                }
            );
        });
            ...
            $.post('/ajax/partners__undo_remove_user',
                ...
                function(result) {
                    ...
                    if (data) {
                        ...
                        obj_this.closest('.my-partners__rcell').find('.js-partner__remove_user').removeClass('is-hidden');
                        obj_this.closest('.my-partners__rcell').find('.js-partner__undo_remove_user').addClass('is-hidden');
                    }
                }
            );
        });
                ...
                function(result) {
                    ...
                    if (data == 'true' ) {
                        if(action_undo == 1) {
                            ...
                            obj_this.find('span').text('Принять заявку');
                        }
                        else
                        {
                            $('.notify-trigger--success').attr('data-notifyTitle', "Готово!")
                            ...
                            obj_this.find('span').text('Отменить');
                        }
        ...
        $('body').on('click', '.js-partner__cancel_request_inbox', function(){
            var obj_this        = $(this),
                new_object      = obj_this.closest('.my-partners__rcell').find('.js-partner__add_user'),
                user_id         = $(this).attr('data-user-id'),
                partner_id      = $(this).attr('data-partner-id'),
                action_undo     = 0;
            ...
            $.post('/ajax/partners__cancel_request',
                ...
                function(result) {
                    ...
                    if (data) {
                        ...
                        obj_this.closest('.my-partners__rcell').find('.add-partner').removeClass('is-hidden');
                        obj_this.closest('.my-partners__rcell').find('.del-partner').addClass('is-hidden');
                    ...
                    if (data) {
                        ...
                        if( obj_this.hasClass('js-partner__send_request_inbox')) {
                            ...
                            $('.notify-trigger--success').attr('data-notifyTitle', "Готово!")
                                ...
                                .click();
                            obj_this.closest('.my-partners__rcell').find('.del-partner').removeClass('is-hidden');
                            obj_this.closest('.my-partners__rcell').find('.add-partner').addClass('is-hidden');
                        }
