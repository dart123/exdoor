...
<script type="text/html" id="change_login__check_pass">
    ...
    <div class="modal__content send-code__block ajax__change_login__container">
        <div class="change_login__description">
            <h2>Почти готово! Введите пароль из смс</h2>
            <p>Мы отправили Ваш новый пароль для авторизации в виде смс на новый номер телефона. Пожалуйста подтвердите его и используйте для доступа к сети exdor.</p>
        </div>
        <form class="ajax__change_login__check_pass" >
            ...
            <input type="submit" class="send-code__submit or-btn btn btn-info is-rounded" value="Готово">
        </form>
    </div>
