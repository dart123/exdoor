            ...
            formatResult:
                function(suggestion, currentValue){
                    ...
                    if( suggestion.type == 'company' ) {
                        ...
                        output += '<span class="search search--news--date">г. ' + suggestion.city + '</span> <br>';
                        ...
                        if( suggestion.company ) {
                            output += '<span class="search search--news--date">Компания: ' + suggestion.company.short_name + '</span>';
