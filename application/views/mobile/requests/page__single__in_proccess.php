                    ...
                    if( $page_content["request_data"]->rating_executor ):?>
                        <div class="req-status__content">
                            <form method="POST" >
                                ...
                                <?php if($page_content["request_data"]->can__set_rating):?><a href="#req__rating" class="fancybox is-blue-link"><i class="fa fa-pencil"></i> <span>Изменить оценку</span></a><?php endif;?>
                            </form>
                        </div>
                    <?php else:?>
                                        ...
                                        <?php if(  $page_content["request_executor"]->responses || ( !$page_content["request_executor"]->responses && $page_content["user_relation"]->status != 'canceled' )  ):?>
                                            ...
                                            <?php else:?>
                                                <?php if( $page_content["request_executor"]->responses[$position->id]->shipping != ''  ):?>
                                                    <p class="request_position__report__in_stock is-grey-text"><i class="fa fa-clock-o"></i> Поставка через <?php echo $page_content["request_executor"]->responses[$position->id]->shipping;?> дн.</p>
                                                <?php else:?>
            ...
            <div class="modal__content">
                ...
                <?php if ( $page_content["request_author"]->id == $this->session->user  ):?>
                    ...
                    <div class="js__set-partners-rating fa-3x <?php if ($page_content["request_data"]->rating_executor > 0): echo 'is-blue-text'; endif;?>" style="text-align: center">
                        <i class="fa <?php if ($page_content["request_data"]->rating_executor >= 1): echo 'js__rating-done fa-star'; else: echo 'js__rating-done fa-star-o '; endif;?> js-rating" id="icon_rating_01"></i>
                        <i class="fa <?php if ($page_content["request_data"]->rating_executor >= 2): echo 'js__rating-done fa-star'; else: echo 'js__rating-done fa-star-o '; endif;?> js-rating" id="icon_rating_02"></i>
                        <i class="fa <?php if ($page_content["request_data"]->rating_executor >= 3): echo 'js__rating-done fa-star'; else: echo 'js__rating-done fa-star-o '; endif;?> js-rating" id="icon_rating_03"></i>
                        <i class="fa <?php if ($page_content["request_data"]->rating_executor >= 4): echo 'js__rating-done fa-star'; else: echo 'js__rating-done fa-star-o '; endif;?> js-rating" id="icon_rating_04"></i>
                        <i class="fa <?php if ($page_content["request_data"]->rating_executor == 5): echo 'js__rating-done fa-star'; else: echo 'js__rating-done fa-star-o '; endif;?> js-rating" id="icon_rating_05"></i>
                    </div>
                ...
                <?php elseif( $page_content["request_executor"] && $page_content["request_executor"]->user_id == $this->session->user ):?>
                    ...
                    <div class="js__set-partners-rating fa-3x <?php if ($page_content["request_data"]->rating_author > 0): echo 'is-blue-text'; endif;?>" style="text-align: center">
                        <i class="fa <?php if ($page_content["request_data"]->rating_author >= 1): echo 'js__rating-done fa-star'; else: echo 'js__rating-done fa-star-o '; endif;?> js-rating" id="icon_rating_01"></i>
                        <i class="fa <?php if ($page_content["request_data"]->rating_author >= 2): echo 'js__rating-done fa-star'; else: echo 'js__rating-done fa-star-o '; endif;?> js-rating" id="icon_rating_02"></i>
                        <i class="fa <?php if ($page_content["request_data"]->rating_author >= 3): echo 'js__rating-done fa-star'; else: echo 'js__rating-done fa-star-o '; endif;?> js-rating" id="icon_rating_03"></i>
                        <i class="fa <?php if ($page_content["request_data"]->rating_author >= 4): echo 'js__rating-done fa-star'; else: echo 'js__rating-done fa-star-o '; endif;?> js-rating" id="icon_rating_04"></i>
                        <i class="fa <?php if ($page_content["request_data"]->rating_author == 5): echo 'js__rating-done fa-star'; else: echo 'js__rating-done fa-star-o '; endif;?> js-rating" id="icon_rating_05"></i>
                    </div>
                    <form id="js__rating_form">
                        <input type="hidden" id="js__request_id" value="<?php echo $page_content["request_data"]->id;?>">
