        ...
        <p class="req-item__descr">
            ...
            if( $positions ):
                foreach ($positions as $lst_position):
                    echo $lst_position->detail."<span class='req-item__comma'>; </span>";
                endforeach;
            endif;
            ?>.
        </p>
    ...
    <div class="req-item__helpers">
        <ul class="req-item__actions is-rounded is-box-shadow">
            ...
            <?php if( $can__set_rating ):?>
                <li class="js__requests__context_menu" data-href="https://exdor.ru/requests/<?php echo $id;?>?set_rating=true">
                    <?php if( $finished ):?>
                        <a>Завершить</a>
                    <?php else:?>
