    ...
    <div class="container">
            ...
            <div class="page-content-form__left">
                ...
                <div class="my-company-search is-mtop-20">
                    ...
                    <div class="my-company-search__title--high">
                        Вы объявили себя сотрудником компании <a href="index-6.html" class="is-blue-link"><span><?php echo $company->short_name;?></span></a>. <br>Мы ожидаем подтверждения этой информации от директора компании.
                    </div>
                                    ...
                                    <div>
                                        <a href="#" class="is-or-link send-remind">
                                            ...
                                            <span href="#" class="is-grey-text is-long-row is-hidden">
                                                <i class="fa fa-clock-o i-left-15"></i>
        ...
        <div id="report" class="modal modal__block is-rounded">
            <div class="modal__head is-rounded">
                ...
                <a href="" class="modal__close-btn">Отменить <i class="fa fa-times"></i></a>
            </div>
            <form action="">
